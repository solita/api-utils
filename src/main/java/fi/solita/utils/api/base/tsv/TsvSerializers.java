...
public class TsvSerializers {
    ...
    public static final <T> TsvSerializer<T> stringSerializer(final Apply<T,? extends CharSequence> f) {
    ...
    public static final <T> TsvSerializer<T> charSerializer(final Apply<T,Character> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> shortSerializer(final Apply<T, Short> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> intSerializer(final Apply<T, Integer> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> longSerializer(final Apply<T, Long> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> doubleSerializer(final Apply<T, Double> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> bigIntegerSerializer(final Apply<T, BigInteger> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> bigDecimalSerializer(final Apply<T, BigDecimal> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    public static final <T> TsvSerializer<T> booleanSerializer(final Apply<T, Boolean> f) {
        return new TsvSerializer<T>() {
            @Override
            public Cells render(TsvModule module, T value) {
    ...
    protected static Cells merge(TsvModule module, Tuple3<?, ?, ?> tuple, Apply<? super String,String> mapFirst, Apply<? super String,String> mapSecond) {
