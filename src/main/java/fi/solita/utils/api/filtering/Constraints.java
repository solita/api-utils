...
public class Constraints<T> {
    ...
    public static final <T> Constraints<T> empty() { return new Constraints<T>(Collections.<FilterType,List<Pair<MetaNamedMember<T,Object>,List<Object>>>>emptyMap()); }
    
    public boolean isEmpty() {
        return filters.isEmpty();
    }
    
    public Constraints(Map<FilterType,List<Pair<MetaNamedMember<T,Object>,List<Object>>>> filters) {
